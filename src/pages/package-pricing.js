            ...
            <main id="main" className="site-main">
                ...
                <div class="entry-content">
                  ...
                  <div className="pricingv2__wrapper">
                    <div className="pricingv2__box silver"><div className="title"><h3 style={{color:"#aaa9ad"}}>SILVER <FontAwesomeIcon icon={['fas', 'star']} /></h3><div>$895</div></div>
                  ...
                  <div className="pricingv2__box gold"><div className="title"><h3  style={{color:"#d4af37"}}>GOLD <FontAwesomeIcon icon={['fas', 'star']} /></h3><div>$1095</div></div>
                    <div className="pricingv2__bullet">Unlimited Pictures for 3 Hours</div>
                    <div className="pricingv2__bullet">The Prop Box</div>
                    <div className="pricingv2__bullet">Set-up and Removal Included</div>
                    <div className="pricingv2__bullet">Professional and Entertaining Attendant</div>
                  ...
                  <div className="pricingv2__box platinum"><div className="title"><h3 style={{color:"#e5e4e2"}}>PLATINUM <FontAwesomeIcon  icon={['fas', 'star']} /></h3><div>$1295</div></div>
                    <div className="pricingv2__bullet">Unlimited Pictures for 3 Hours</div>
                    <div className="pricingv2__bullet">The Prop Box</div>
                    <div className="pricingv2__bullet">Set-up and Removal Included</div>
                    <div className="pricingv2__bullet">Professional and Entertaining Attendant</div>
